...
response.getWriter().println("<h4><span style='color:red'>That ID <q>" + id 
+ "</q> does not match the numeric format or is too big.</h4>");
response.getWriter().println("<br><form method=\"post\"action=\"product.html\"><button type=\"submit\">Try Again</button></form>");
}
else if(name.equals(""))
{
response.setContentType("text/html");
response.getWriter().println("<h4><span style='color:red'>That Name <q>" 
+ name + "</q> is invalid.</h4>");
response.getWriter().println("<br><form method=\"post\" 
action=\"product.html\"><button type=\"submit\">Try Again</button></form>");
}
else if(description.equals(""))
{
response.setContentType("text/html");
response.getWriter().println("<h4><span style='color:red'>That Description 
<q>" + description + "</q> is invalid.</h4>");
response.getWriter().println("<br><form method=\"post\" 
action=\"product.html\"><button type=\"submit\">Try Again</button></form>");
}
else
